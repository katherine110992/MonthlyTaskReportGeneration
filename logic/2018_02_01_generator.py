...
for filename in os.listdir(path):
    ...
    if "Performance" in name:
        ...
        elif component_name == "DetectSpecialCharacters_Server" or component_name == "DetectSpecialCharacters":
            component_name = "DetectSpecialCharacters en FoodDetection"
        elif component_name == "DetectEmojisWithSpacymoji_Server" or component_name == "DetectEmojisWithSpacymoji":
            component_name = "DetectEmojisWithSpacymoji en FoodDetection"
        elif component_name == "DetectEmoticonsWithMatch_Server" or component_name == "DetectEmoticonsWithMatch":
            component_name = "DetectEmoticonsWithMatch en FoodDetection"
        elif component_name == "DetectEmoticonsWithRegex_Server" or component_name == "DetectEmoticonsWithRegex":
            component_name = "DetectEmoticonsWithRegex en FoodDetection"
        elif component_name == "DetectEmoticonsFacesWithRegex_Server" or component_name == "DetectEmoticonsFacesWithRegex":
            component_name = "DetectEmoticonsFacesWithRegex en FoodDetection"
        elif component_name == "DetectEmoticonsFacesWithRegex_Server" or component_name == "DetectEmoticonsFacesWithRegex":
            component_name = "DetectEmoticonsFacesWithRegex en FoodDetection"
        elif component_name == "DetectCompleteEmoticonsWithRegex_Server" or component_name == "DetectCompleteEmoticonsWithRegex":
            component_name = "DetectCompleteEmoticonsWithRegex en FoodDetection"
        elif component_name == "DetectRegexSpecialEntitiesRawData_Server" or component_name == "DetectRegexSpecialEntitiesRawData":
            component_name = "DetectRegexSpecialEntitiesRawData en FoodDetection"
        else:
